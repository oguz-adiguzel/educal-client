...
const MainSection = () => {
  return (
    <div className='w-full flex flex-col lg:flex-row justify-center py-3 lg:py-48'>
        <div className='w-full lg:w-2/6 py-10 px-2 lg:px-0 flex flex-col justify-center items-start'>
        ...
        <div className='w-full lg:w-2/6 py-10 px-3 lg:px-0 flex items-start relative'>
            ...
            <img className='w-full lg:w-2/3 rounded-tl-[50px] rounded-br-[50px]' src='hero-1.jpg' />
            <img className='w-1/3 hidden lg:block rounded-tr-[50px] rounded-bl-[50px] mt-14 ml-10' src='hero-sm-1.jpg' />
